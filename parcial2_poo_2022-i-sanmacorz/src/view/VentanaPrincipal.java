...
public class VentanaPrincipal extends JFrame {
        ...
        public DialogoDepositar miDialogoDepositar;
        public DialogoRetirar miDialogoRetirar;
        ...
        public void crearDialogoDepositar() {
                miDialogoDepositar = new DialogoDepositar();
        }

        public void crearDialogoRetirar() {
                miDialogoRetirar = new DialogoRetirar();
        }
}
